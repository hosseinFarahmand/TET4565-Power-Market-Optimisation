...
#-------------------------------------------------------------------------------
# Plotting Upper and Lower Bound Variations
plt.figure(figsize=(10, 6))
plt.plot(range(1, iteration), lower_bounds, label='Lower Bound', marker='o')
plt.plot(range(1, iteration), upper_bounds, label='Upper Bound', marker='o')
plt.xlabel('Iteration')
plt.ylabel('Bound Value')
plt.title('Upper and Lower Bound Variations per Iteration')
plt.legend()
plt.grid(True)
plt.show()
